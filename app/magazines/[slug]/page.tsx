...
import { useMagazine } from "@/hooks/useStrapi";
...
export default function MagazineDetail() {
  ...
  const { data: magazineData, error: magazineError } = useMagazine(slug);
  const magazine = magazineData?.data?.[0] ?? null;

  if (!magazine && !magazineError) {
    return (
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-red-500 mb-4">Magazine Not Found</h1>
      ...
      <section className="w-[85vw] mx-auto pb-16">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-3xl font-bold text-[#0070ae] mb-6">Table of Contents</h2>
            ...
            {magazine.entries && magazine.entries.length > 0 ? (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          {entry.author && (
                            <p className="text-gray-600 italic text-sm">by {entry.author}</p>
                          )}
                        </div>
              ...
              <div className="text-center py-8">
                <p className="text-gray-500 text-lg">No entries found for this magazine issue.</p>
              </div>
            )}
          </div>
        </div>
